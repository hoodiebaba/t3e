...
// We no longer use a local EmploymentEntryData in the props.
// formData is typed as `any` so that the parent’s BgvFormData can pass through without mismatch.
...
const Step5_EmploymentVerification: React.FC<Step5Props> = ({
  ...
  // Now treat employmentEntries as any[] (no local EmploymentEntryData)
